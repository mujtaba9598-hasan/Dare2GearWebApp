...
export const DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    scenicScore: 84,
    bestMonths: "Apr–Oct",
    blurb: "One of the world's highest cold deserts — vast silver dunes on the Shigar valley floor, ringed by snow peaks and home to an annual jeep rally.",
    attractions: ["Sand dunes", "Jeep Rally track", "Dune camping", "Star gazing", "Shigar Fort nearby"],
    terrain: "mixed",
  },
  {
    id: "katpana",
    ...
    scenicScore: 80,
    bestMonths: "Apr–Oct",
    blurb: "High-altitude sand dunes minutes from Skardu town — the famous 'cold desert' where dunes meet the Indus and the Karakoram on the horizon.",
    attractions: ["Sand dunes", "Desert camp", "Sunset over the Indus", "Skardu airport view", "Bonfire nights"],
    terrain: "mixed",
  },
