...
export const DESTINATIONS: Destination[] = [
  ...
  // --- Added 2026-06 (folder drop: "New Destinations") -----------------------
  // Coordinates verified by research; corridor legs (corridors.ts) are researched
  // approximations — re-run gen:roads / spot-check vs Google to refine later.
  {
    id: "balakot",
    name: "Balakot",
    region: "Kaghan Valley, KPK",
    ...
    scenicScore: 70,
    bestMonths: "Mar–Oct",
    blurb: "Riverside gateway town to the Kaghan Valley, rebuilt on the Kunhar after the 2005 quake and ringed by green ridges.",
    attractions: ["Kunhar River", "Demanchi", "Kaghan Road", "Balakot Bazaar"],
    terrain: "highway",
  },
  {
    id: "batakundi",
    ...
    scenicScore: 80,
    bestMonths: "May–Sep",
    blurb: "A high alpine hamlet past Naran on the road to Babusar, lined with riverside hotels and pine-clad slopes.",
    attractions: ["Batakundi Village", "Riverside Hotels", "Kunhar River", "Burawai"],
    terrain: "mixed",
  },
  {
    id: "battagram",
    ...
    scenicScore: 55,
    bestMonths: "Mar–Nov",
    blurb: "A district town strung along the Karakoram Highway — a green valley stopover beneath the forested Allai hills.",
    attractions: ["Battagram Valley", "Allai Valley", "Karakoram Highway", "Thakot Bridge"],
    terrain: "highway",
  },
  {
    id: "goldenvalley",
    name: "Golden Valley (Golen)",
    region: "Golen Valley, Chitral, KPK",
    lat: 35.9,
    lng: 71.95,
    tier: "high",
    costFactor: 1.35,
    scenicScore: 82,
    bestMonths: "Jun–Sep",
    blurb: "The remote Golen (Golden) valley branching off near Chitral Gol — a jeep-track wilderness of glacier streams and high pasture.",
    attractions: ["Golen Gol", "Chitral Gol National Park", "Koghuzi Turnoff", "Glacier Streams"],
    terrain: "rough",
  },
  {
    id: "haramosh",
    ...
    scenicScore: 90,
    bestMonths: "Jun–Sep",
    blurb: "A glacier-walled valley east of Gilgit guarded by Haramosh and Dobani peaks, ending at jewel-blue Kutwal Lake.",
    attractions: ["Kutwal Lake", "Haramosh Peak", "Dobani Peak", "Khaltaro Valley", "Laila Peak"],
    terrain: "rough",
  },
  {
    id: "ishkoman",
    name: "Ishkoman Valley",
    region: "Ghizer, Gilgit-Baltistan",
    lat: 36.5158,
    lng: 73.8492,
    tier: "high",
    costFactor: 1.35,
    scenicScore: 86,
    bestMonths: "Jun–Sep",
    blurb: "A long northern Ghizer valley running up toward the Afghan frontier, capped by the turquoise expanse of Karambar Lake.",
    attractions: ["Karambar Lake", "Ishkoman Village", "Ghizer River", "Phakora"],
    terrain: "rough",
  },
  {
    id: "lowaritop",
    name: "Lowari Top",
    region: "Lowari Top, Chitral, KPK",
    lat: 35.3517,
    lng: 71.8,
    tier: "medium",
    costFactor: 1.2,
    scenicScore: 78,
    bestMonths: "Jun–Oct",
    blurb: "A snow-prone 3,118 m pass between Dir and Chitral, now bypassed below by the long Lowari Tunnel.",
    attractions: ["Lowari Pass Top", "Lowari Tunnel", "Switchback Road", "Summit Viewpoint"],
    terrain: "mixed",
  },
  {
    id: "nakyal",
    name: "Nakyal",
    region: "Kotli, Azad Kashmir",
    lat: 33.4875,
    lng: 74.1051,
    tier: "low",
    costFactor: 1.05,
    scenicScore: 62,
    bestMonths: "Mar–Nov",
    blurb: "A green hill tehsil in Kotli near the Line of Control — terraced fields and forested ridges above the bazaar.",
    attractions: ["Nakyal Bazaar", "Fatehpur Thakyala", "Forested Ridges", "LoC Viewpoints"],
    terrain: "mixed",
  },
  {
    id: "siranvalley",
    ...
    scenicScore: 80,
    bestMonths: "Apr–Oct",
    blurb: "A lush, off-the-radar valley on the Siran River near Mansehra — pine forests, waterfalls and gentle treks.",
    attractions: ["Siran Waterfall", "Khanda Gali", "Forest of Jacha", "Chorr Khanda Gali"],
    terrain: "mixed",
  },
  {
    id: "thuipass",
    ...
    scenicScore: 92,
    bestMonths: "Jul–Sep",
    blurb: "A remote ~4,500 m Hindu Kush trekking pass linking Yarkhun in Chitral with Ishkoman, beside the icy Bari Lake.",
    attractions: ["Thui Pass", "Bari Lake", "Yarkhun Lasht", "Yarkhun Valley"],
    terrain: "rough",
  },
];
